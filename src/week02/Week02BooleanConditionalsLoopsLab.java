...
int numberOfCookiesRemaining = (numberOfCookies % numberOfChildren);
if (numberOfCookiesRemaining == 0) {
	System.out.println("Sad Face");
} else if (numberOfCookiesRemaining < 2) {
	System.out.println("Yes!");
}else if (numberOfCookiesRemaining < 5) {
...
System.out.println("Your loyalty member status after this purchase is " + loyaltyMemberStatus + "!");
